...
var _user$project$Version$version = 'v3.0-beta-17-g97ba9a5';
...
var _user$project$Bracket$getClosr3 = F2(
	function (opener, bmap) {
		return A2(
			...
			A2(
				...
				_user$project$Bracket$matchEnabledOpenrX(opener),
				bmap));
	});
